...
export default function HomePage() {
  return (
    <main className="min-h-screen bg-background">
      {/* Hero Section */}
      <section className="relative h-[70vh] bg-gradient-to-r from-primary to-accent flex items-center justify-center">
        <div className="text-center space-y-4 p-8">
          <h1 className="text-5xl font-bold text-background">ChromaFlow Shop</h1>
          <p className="text-xl max-w-2xl mx-auto text-background-subtle">
            Discover our curated collection of products with a dynamically themed shopping experience
          </p>
          <div className="mt-8">
            <Link 
              href="/products" 
              className="bg-background text-primary px-8 py-3 rounded-full font-semibold hover:opacity-90 transition-all"
            >
              Shop Now
            </Link>
          </div>
      ...
      <section className="py-16 px-8 bg-background-subtle">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-4 text-gradient">Customize Your Experience</h2>
          ...
          <Link 
            href="/theme-settings" 
            className="btn-accent inline-block rounded-full p-2"
          >
            Customize Theme
          </Link>
        </div>
